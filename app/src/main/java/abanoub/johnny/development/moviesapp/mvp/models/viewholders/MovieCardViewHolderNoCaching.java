...
public class MovieCardViewHolderNoCaching extends RecyclerView.ViewHolder {
    ...
    public MovieCardViewHolderNoCaching(View itemView, Context context) {
        super(itemView);
    ...
    public void bind(Movie movie){
        if (movie!=null) {
            Glide.with(mContext).load(BuildConfig.Base_Image_URL+movie.getPosterPath())
                    .diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).placeholder(R.color.colorPrimaryDark).into(movieImageView);
